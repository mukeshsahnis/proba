...
export async function POST({ request }) {
	try {
		...
		const { topic, level, questionText, userAnswer, isCorrect, requestType, customPrompt } = validation.data;
...
`;
		...
		const message = data?.choices?.[0]?.message?.content || 'I am here to help you master probability step by step!';
