<script>
	...
	let { type = 'coin', total = 2, favorable = 1, isFlipping = false, selectedIndex = null } = $props();
...
<div class="relative flex flex-col items-center justify-center p-2 rounded-xl bg-gradient-to-b from-amber-50/60 to-orange-50/40 border border-amber-900/10 shadow-xs backdrop-blur-sm overflow-hidden h-full">
	<svg bind:this={svgRef} class="w-full max-w-xs h-36">
		<defs>
	...
	<div class="mt-0.5 text-[10px] font-mono text-amber-800 flex items-center gap-1.5 shrink-0">
